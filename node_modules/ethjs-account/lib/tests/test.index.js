...
describe('ethjs-account', function () {
  describe('privateToAccount', function () {
    ...
    it('should be the same as ethereumjs-util', function () {
      var privateKey = '0xcc136826fbd5192c10bba496af42906a7e3b91f87a0ae803e79113fa88c543cc';
    ...
    it('should generate valid hex keys', function () {
      for (var i = 0; i < 10000; i++) {
        // eslint-disable-line
        var testGenerate = generate('sdfksdkfjksjdfkjsdkjsdfjsdfjkshdfkjhsdfkjhsdkjfhskdjfhsfjhsfkjhsdfjhs');
        assert.equal(new Buffer(testGenerate.privateKey.slice(2), 'hex').toString('hex'), testGenerate.privateKey.slice(2).toLowerCase());
        assert.equal(new Buffer(testGenerate.privateKey.slice(2), 'hex').length % 2, 0);
      }
    });
    ...
    it('should function normally', function () {
      var testAccount = privateToAccount('0x' + keccak256('sfddskj'));
  ...
  describe('privateToPublic', function () {
    it('should construct properly', function () {
      ...
      assert.equal(typeof privateToPublic('0x' + keccak256('jksfksf')), 'object');
    });
  ...
  describe('publicToAddress', function () {
    it('should construct properly', function () {
      ...
      assert.equal(typeof publicToAddress(privateToPublic('0x' + keccak256('jksfksf'))), 'string');
    });

    it('should be the same as ethereumjs-util', function () {
      var accountTest = privateToAccount('0x' + keccak256('kjsdfkjfkjsf'));
      var publicKey = new Buffer(accountTest.publicKey.slice(2), 'hex');
