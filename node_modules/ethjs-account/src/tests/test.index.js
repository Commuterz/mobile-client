...
describe('ethjs-account', () => {
  describe('privateToAccount', () => {
    ...
    it('should be the same as ethereumjs-util', () => {
      const privateKey = '0xcc136826fbd5192c10bba496af42906a7e3b91f87a0ae803e79113fa88c543cc';
    ...
    it('should generate valid hex keys', () => {
      for (var i = 0; i < 10000; i++) { // eslint-disable-line
        const testGenerate = generate('sdfksdkfjksjdfkjsdkjsdfjsdfjkshdfkjhsdfkjhsdkjfhskdjfhsfjhsfkjhsdfjhs');
    ...
    it('should function normally', () => {
      const testAccount = privateToAccount(`0x${keccak256('sfddskj')}`);
  ...
  describe('publicToAddress', () => {
    ...
    it('should be the same as ethereumjs-util', () => {
      const accountTest = privateToAccount(`0x${keccak256('kjsdfkjfkjsf')}`);
      const publicKey = new Buffer(accountTest.publicKey.slice(2), 'hex');
